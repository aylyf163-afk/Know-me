      ...
      items: [
        {
          ...
          summary: 'Internal data visualization platform with dashboards, permissions, and high-performance chart components.',
        ...
        },
        {
          ...
          role: 'Front-end Engineer',
          project: 'Merchant Operations Console',
          title: 'Project Two (replace with yours)',
          image: '/projects/project-2.png',
          stack: ['Vue 3', 'Pinia', 'ECharts'],
          summary: 'Merchant operations console covering RBAC, analytics dashboards, exports, and alert subscriptions.',
        ...
        },
        {
          ...
          role: 'Front-end Engineer',
          project: 'Cloud Console Optimization',
          title: 'Project Three (replace with yours)',
          image: '/projects/project-3.png',
          stack: ['Node.js', 'WebSocket', 'Docker'],
          summary: 'Improved console performance and reliability, refining interactions and realtime push experience.',
          goals: ['Realtime push latency < 200ms', 'Reduced API error rate by 35%', 'Stable production operation'],
        },
        {
          company: 'Project Four',
          period: '2024',
          role: 'Front-end',
          project: 'Scrollytelling Portfolio',
        ...
        {
          company: 'Project Five',
          period: '2024',
          role: 'Front-end',
          project: 'Performance & DX Governance',
